...
public class FireballText : MonoBehaviour
{
    ...
    public void ShowFireballMessage(string message, Color color)
    {
        ...
        currentRoutine = StartCoroutine(AnimateFireballFloatingText());
    }

    private IEnumerator AnimateFireballFloatingText()
    {
        float elapsed = 0f;
